    ...
    <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{route('profile.storeBookAgree',['code'=>$review->code])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="title-h">
                                    <span>Xác nhận nhận sách</span>
                                </div>
                                ...
                                <div class="text-right">
                                    <a href="{{ route('profile.bookCancel',['code'=>$review->code]) }}" class="btn btn-warning">Nhận điểm thay vì nhận sách</a>
                                </div>
                                 <div class="text-right">
                                ...
                                <div class="card card-outline card-primary">
                                    <div class="card-body table-responsive p-3">
                                        <div class="form-group">
                                            <label class="" for="">Tên người nhận <span class="red">*</span></label>
                                            <input type="text" class="form-control
                                             @error('name_nhan') is-invalid @enderror"  value="{{ old('name_nhan') }}" name="name_nhan" placeholder="Tên người nhận">
                                            @error('name_nhan')
                                        ...
                                        <div class="form-group">
                                            <label class="" for="">Số điện thoại người nhận <span class="red">*</span></label>
                                            <input  type="text" class="form-control
                                            @error('phone_nhan') is-invalid  @enderror"  value="{{ old('phone_nhan') }}" name="phone_nhan" placeholder="Nhập số điện thoại người nhận">
                                            @error('phone_nhan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            <label class="" for="">Nhập địa chỉ người nhận <span class="red">*</span></label>
                                            <textarea class="form-control  @error('address_nhan') is-invalid @enderror" name="address_nhan" id="" rows="3"  placeholder="Nhập địa chỉ người nhận">{{ old('address_nhan') }}</textarea>
                                            @error('address_nhan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="" for="">Nhập thông tin thêm</label>
                                            <textarea class="form-control  @error('info_mhan') is-invalid  @enderror" name="info_mhan" id="" rows="3" value="" placeholder="Nhập thông tin thêm"> {{ old('info_mhan') }}</textarea>
                                            @error('info_mhan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
