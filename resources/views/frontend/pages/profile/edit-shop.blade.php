    ...
    <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                    <form action="{{route('profile.updateShop')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="title-h">
                                    ...
                                    <div class="card-body table-responsive p-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control
                                             @error('name_store') is-invalid @enderror"  value="{{ old('name_store')??$data->name_store }}" name="name_store" placeholder="Tên gian hàng">
                                            @error('name_store')
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input  type="text" class="form-control
                                            @error('address_store') is-invalid  @enderror"  value="{{ old('address_store')??$data->address_store }}" name="address_store" placeholder="Nhập địa chỉ gian hàng">
                                            @error('address_store')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="wrap-load-image mb-3">
                                            ...
                                            @enderror
                                            <img class="img-load border p-1 w-100" src="{{ $data->logo_store }}"
                                                alt="{{ $data->name }}"
