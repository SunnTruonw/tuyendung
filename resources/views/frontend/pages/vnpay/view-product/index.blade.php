...
@section('content')
    <div class="content-wrapper">
        <div class="main">
            <div class="blog-payment pt-5 pb-5">
                <div class="container">
                    <div class="card">
                        @if(session("mes"))
                        ...
                        @endif
                        <div class="card-header text-center bg-while" style="font-size: 20px; font-weight: bold;">
                            Nạp tiền vào tài khoản
                            @if (request()->money)
                                <h3 class="text-center red">
                                   {{  number_format(request()->money) }} VNĐ
                                </h3>
                            @endif
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{ route('profile.storePaymentCartView') }}" id="create_form" method="post">
                                    @csrf
                                    <input class="form-control"  required
                                    name="product_view" type="hidden" value="{{ request()->product_view }}" />
                                    {{-- <div class="form-group">
                                        <label for="language">Loại </label>
                                    ...
                                    <div class="form-group">
                                        <input class="form-control"  required
                                               name="amount" type="hidden" value="{{ request()->money }}" placeholder="Nhập số tiền"/>
                                    </div>
                                    @else
                                    <div class="form-group">
                                        <label for="amount">Số tiền</label>
                                        <input class="form-control" id="amount" required
                                               name="amount" type="number" value="{{ request()->money }}" placeholder="Nhập số tiền"/>
                                    </div>
                                    @endif
                                    {{-- <div class="form-group">
