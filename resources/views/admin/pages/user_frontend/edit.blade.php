                     ...
                     <div class="col-md-12">
                        ...
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Thông tin tài khoản : <strong>{{ $data->username }}</strong></h3>
                                 ...
                                 {{-- <div class="row">
                                     ...
                                     <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="district_id" id="district" class="form-control" required="required" data-url="{{ route('ajax.address.communes') }}">
                                               @if ($data->district_id)
                                               <option value="{{ $data->district_id }}">{{ optional($data->district)->name }}</option>
                                               @else
                                     ...
                                     <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="commune_id" id="commune" class="form-control" required="required">
                                                @if ($data->commune_id)
                                                <option value="{{ $data->commune_id }}">{{ $data->commune->name }}</option>
                                                @else
                                     ...
                                     <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            value="{{ old('address_detail')?? $data->address_detail }}" name="address_detail" placeholder="Địa chỉ cụ thể">
