...
@section('title',"Thêm gói")

@section('content')
<div class="content-wrapper">
   @include('admin.partials.content-header',['name'=>"Gói","key"=>"Thêm gói"])
   <!-- Main content -->
   <div class="content">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Thông tin gói sản phẩm</h3>
                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            @error('name_'.$langItem['value']) is-invalid @enderror" id="name_{{$langItem['value']}}" value="{{ old('name_'.$langItem['value']) }}" name="name_{{$langItem['value']}}" placeholder="Nhập tên gói">
                                                ...
                                                {{-- <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            @error('value_'.$langItem['value']) is-invalid  @enderror" id="value_{{ $langItem['value'] }}" value="{{ old('value_'.$langItem['value']) }}" name="value_{{ $langItem['value'] }}" placeholder="Nhập value">
                    ...
                    <div class="col-md-12">
                        <div class="card card-outline card-primary">
                            ...
                            <div class="card-body table-responsive p-3">
                                ...
                                <br/>
                                <div class=""><a data-url="{{route('admin.attribute.loadChildAttribute') }}" class="btn  btn-info btn-md float-right " id="addOptionProduct">+ Thêm mới </a></div>
                            </div>
                        </div>
                    </div>
