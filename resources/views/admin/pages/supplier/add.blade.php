...
@section('title',"Thêm supplier")
@section('css')
@endsection
@section('content')
<div class="content-wrapper">
    @include('admin.partials.content-header',['name'=>"supplier","key"=>"Thêm nhà cung cấp"])
    <!-- Main content -->
    <div class="content">
                            ...
                            <div class="card card-outline card-primary">
                                ...
                                <div class="card-body table-responsive p-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control
                                        @error('fax') is-invalid @enderror" id="fax" value="{{ old('fax') }}" name="fax" placeholder="Nhập fax">
                                        @error('fax')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control
                                        @error('phone') is-invalid @enderror" id="fax" value="{{ old('phone') }}" name="phone" placeholder="Nhập số điện thoại">
                                        @error('phone')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control
                                        @error('email') is-invalid @enderror" id="fax" value="{{ old('email') }}" name="email" placeholder="Nhập Email">
                                        @error('email')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control
                                        @error('website') is-invalid @enderror" id="fax" value="{{ old('website') }}" name="website" placeholder="Nhập website">
                                        @error('website')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="card-body table-responsive p-3">
                                    <div class="wrap-load-image mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control-file img-load-input border @error('logo_path')
                                            is-invalid
                                            @enderror" id="" name="logo_path">
                                            @error('logo_path')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
