...
class Attribute extends Model
{
    ...
    {
        return $this->translations->first()->time_start;
    }

    // tạo thêm thuộc tính name
    public function getTimeEndAttribute()
    {
        return $this->translations->first()->time_end;
    }

    // tạo thêm thuộc tính name
    public function getYearAttribute()
    {
        return $this->translations->first()->year;
    }
    ...
    {
        return $this->hasMany(AttributeImage::class, "attribute_id", "id");
    }
}
