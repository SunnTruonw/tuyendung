...
class AdminReviewCommentController extends Controller
{
    //
    ...
    private $settingConfig=[
        'model'=>'review',
        'permissionActive'=>'comment-review-active',
        'permissionDelete'=>'comment-review-delete',
        'routeActive'=>'admin.review.loadActiveComment',
        'routeDelete'=>'admin.review.comment.destroy',
        'routeList'=>'admin.review.comment.index',
    ];
